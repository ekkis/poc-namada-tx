...
To be able to follow, you'll need some basic infrastructure.  Please refer to the [SETUP] file before getting started and everything is set up, let's create a new project (I've chosen to call it _poc-namada-tx_ but you can call it what you like):
